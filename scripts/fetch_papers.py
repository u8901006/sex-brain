#!/usr/bin/env python3
"""
Fetch latest sexuality / sex counseling / sexual neuroscience research papers from PubMed E-utilities API.
Targets core sexology, psychosexual therapy, and sexual neuroscience journals.
"""
...
HEADERS = {"User-Agent": "SexBrainBot/1.0 (research aggregator)"}
...
def main():
    parser = argparse.ArgumentParser(description="Fetch sexuality papers from PubMed")
